          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="explore" className="block text-gray-300 hover:text-white transition-colors">Latest Articles</a>
                <a href="explore" className="block text-gray-300 hover:text-white transition-colors">Research</a>
